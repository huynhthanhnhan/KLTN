...
var createScene = function() {
    ...
    function CreateCubeWithCenterSize(center, size) {
        ...
        var l1 = CreateLine(p1.position, p2.position);
        var l2 = CreateLine(p2.position, p3.position);
        var l3 = CreateLine(p3.position, p4.position);
        var l4 = CreateLine(p4.position, p1.position);
        var l5 = CreateLine(p1.position, p5.position);
        var l6 = CreateLine(p2.position, p6.position);
        var l7 = CreateLine(p3.position, p7.position);
        var l8 = CreateLine(p4.position, p8.position);
        var l9 = CreateLine(p5.position, p6.position);
        var l10 = CreateLine(p6.position, p7.position);
        var l11 = CreateLine(p7.position, p8.position);
        var l12 = CreateLine(p8.position, p5.position);
    }

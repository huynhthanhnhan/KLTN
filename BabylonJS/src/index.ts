...
var createScene = function() {
    ...
    cbPointMode.onclick = function() {
        ...
        isCreatePointMode = self.checked;
    ...
    cbMultiLineMode.onclick = function() {
        ...
        isCreateMultiLineMode = self.checked;
        if (startPoint) {
            hl.removeMesh(startPoint);
            startPoint = "";
        }
            ...
            if ((isCreateLineMode || isCreateMultiLineMode)) {
                if (pickResult.pickedMesh.name != "point") {
                    ...
                    if (isStartCreateLine) {
                        ...
                        if (startPoint) {
                            var s = CreateLine(startPoint.position, pt.mesh.position, scene, isCreatePointMode, hl);
                            listLine.push(s);
                    ...
                    if (isStartCreateLine) {
                        ...
                        if (startPoint) {
                            var s = CreateLine(startPoint.position, pickResult.pickedMesh.position, scene, isCreatePointMode, hl);
                            listLine.push(s);

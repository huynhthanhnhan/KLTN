...
{
    var polygon = BABYLON.MeshBuilder.CreateCylinder("pyramid"+index, { diameterTop: 0, diameter: 8, height: 5, tessellation:4 }, scene);
...
{
    var polygon = BABYLON.MeshBuilder.CreateCylinder("pyramid"+index, { diameterTop: 0, diameter: 8, height: height, tessellation: points }, scene);
